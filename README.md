# Queryclin — HCE Intelligence Dashboard (V4.3.8)
...
### Fase 20: Refinamiento de Mappings HCE-MIR (V4.3.8 — ACTUAL 🚀)
...
- **Mapeo de Constantes Vitales**: Inclusión de Oxihemoglobina (O2 Hb) y Detalles HTA en el bloque de constantes inmutables.
